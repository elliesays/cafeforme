...
1. 고객이 회원가입을 한다.
2. 고객이 회원탈퇴를 한다.
3. 유효한 멤버십 번호로 주문접수가 완료되면, 포인트가 적립된다.

- [비기능적 요구사항]
    1. 고객이 포인트를 수시로 조회할 수 있어야한다.  CQRS
...
## TO-BE 조직 (Vertically-Aligned)
  ![image](https://user-images.githubusercontent.com/57605719/81781230-c5f08880-9532-11ea-9139-f66aa5ca6854.png)
